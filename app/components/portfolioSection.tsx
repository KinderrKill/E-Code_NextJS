...
export default function PortfolioSection() {
  ...
  return (
    <>
      <div className='portfolio-section mt-16 pt-16'>
        ...
        <section className='flex flex-col items-center justify-center mt-10'>
          ...
          <article className='grid grid-cols-1 md:grid-cols-3'>
            {getListedItems().map((item, index) => {
              return (
                <a key={index} href={item.link} target='_blank' className='mb-8'>
                  <div className='card-3d'>
                    <div className='wrapper'>
                      <Image src={item.images.background} className='cover-image' alt='' />
                    </div>
                    <Image src={item.images.character} className='character' alt='' />
                    <span className='title text-center'>
                      <Image src={item.images.logo} alt='' />
                      {item.label}
                    </span>
                  </div>
                </a>
